...
mongo epsinosql --eval 'db.customer.find ({ address2: null })' >> td4-THIAW-WING-KAI-LOIC.log
mongo epsinosql --eval 'db.orders.find( { $or: [ { paid_date : { $type: 11 }}, { paid_date: null }, { paid_date: { $exists: false } } ] } )' >> td4-THIAW-WING-KAI-LOIC.log
echo "------------------------------------------------------------------------------" >> td4-THIAW-WING-KAI-LOIC.log
echo "------------------------------------------------------------------------------" >> td4-THIAW-WING-KAI-LOIC.log
...
mongo epsinosql --eval 'db.customer.find( { state: "CA", fname: "Arnold" }, {fname: 1, lname: 1} )' >> td4-THIAW-WING-KAI-LOIC.log
mongo epsinosql --eval 'db.customer.find( { zipcode: "85008"}, {fname: 1, lname: 1} )' >> td4-THIAW-WING-KAI-LOIC.log
echo "------------------------------------------------------------------------------" >> td4-THIAW-WING-KAI-LOIC.log
echo "------------------------------------------------------------------------------" >> td4-THIAW-WING-KAI-LOIC.log
